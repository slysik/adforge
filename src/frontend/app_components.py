...
from src.backend.templates import LayoutTemplate, TEMPLATE_RENDERERS, auto_select_template
...
SAMPLE_BRIEFS = {
    "Coastal Collection 2025 (Blue Beach House Designs)": "data/sample_briefs/beach_house_campaign.yaml",
    "Holiday Glow 2025 (LuxeBeauty)": "data/sample_briefs/holiday_campaign.yaml",
}
