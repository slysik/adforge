...
@click.option(
    "--input-dir", "-i", default="data/input_assets", help="Directory with existing assets"
)
@click.option(
    "--output-dir",
    "-o",
...
def generate(
    ...
    \b
    Examples:
        adforge generate data/sample_briefs/summer_campaign.yaml --mock
...
def analyze(brief: str, llm: bool):
    ...
    \b
    Examples:
        adforge analyze data/sample_briefs/summer_campaign.yaml
